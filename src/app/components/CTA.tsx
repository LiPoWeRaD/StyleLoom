...
const CTA = () => {
    return (
        <div className="relative grid grid-cols-1 lg:grid-cols-6 gap-y-[40px] px-[20px] py-[30px] lg:p-20 bg-brown70 rounded-lg overflow-x-hidden">
            ...
            <div className="flex flex-col items-center justify-center gap-y-[30px] col-span-12 md:col-end-12 ">

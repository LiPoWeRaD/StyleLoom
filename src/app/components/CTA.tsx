...
const CTA = () => {
    return (
        <div className="relative grid grid-cols-1 lg:grid-cols-6 gap-y-[40px] px-[20px] py-[30px] lg:p-20 bg-brown70 rounded-lg overflow-hidden">
            <Image src={CTAImage} alt="CTA" className="absolute top-0 right-0 w-1/2 2xl:w-1/3 h-6/12 md:h-full" />
            <div className="flex flex-col gap-y-[30px] col-span-6 lg:col-span-4 ">
            ...
            <div className="flex flex-col items-center justify-center lg:items-end gap-y-[30px] col-span-12 lg:col-span-2 ">
                <Btn className="!bg-dark12 w-full lg:w-auto z-10" >
                    Shop Now
                </Btn>
            </div>
        </div>
